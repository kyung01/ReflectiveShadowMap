...
namespace NGraphic {
	enum KEnum {
		...
		RENDER_TYPE_DEFFERED_DIFFUSE, RENDER_TYPE_DEFFERED_NORMAL, RENDER_TYPE_DEFFERED_WORLD,	RENDER_TYPE_DEFFERED_SPECULAR,
		RENDER_TYPE_DEFFERED_LIGHT,
		RENDER_TYPE_DEFFERED_LIGHT_DIFFUSE, RENDER_TYPE_DEFFERED_LIGHT_NORMAL, RENDER_TYPE_DEFFERED_LIGHT_WORLD, RENDER_TYPE_DEFFERED_LIGHT_SPECULAR,
